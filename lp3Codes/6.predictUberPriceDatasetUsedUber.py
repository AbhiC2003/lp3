''' Assignment 1: Predict the price of the Uber ride from a given pickup point to the agreed drop-off location.
...
# Load the dataset
data = pd.read_csv('/media/rover/Acer/Stuffs/Books/Curriculum/7th sem practicals/lp3Codes/uber.csv')
