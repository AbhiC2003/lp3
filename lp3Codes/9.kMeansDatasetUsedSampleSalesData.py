'''Assignment No. 4
Aim: Implement K-Means clustering/ hierarchical clustering on sales_data_sample.csv dataset.Determine
...
# Load the dataset
data = pd.read_csv('/media/rover/Acer/Stuffs/Books/Curriculum/7th sem practicals/lp3Codes/sales_data_sample.csv', encoding='ISO-8859-1')
